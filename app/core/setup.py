...
#         RedisSettings(host=settings.REDIS_QUEUE_HOST,
...
def create_application(router: APIRouter, settings, **kwargs) -> FastAPI:
    ...
    **kwargs 
    ...
    templates_dir = os.path.join(os.getcwd(), "my-react-app", "dist",)
    ...
    #         cache.ClientCacheMiddleware, max_age=settings.CLIENT_CACHE_MAX_AGE)
